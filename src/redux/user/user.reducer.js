...
const userReducer = (state = INITIAL_STATE, action) => {
    ...
    switch (action.type) {
        case USER_ACTION_TYPES.SET_CURRENT_USER: // whenever SET_CURRENT_USER is the action type that gets fired, we return a new object which represents the new state
            return {
